function qpi=top_charge_pi_lambda( cont_pi, singularities_pi, step, n_t, delta,J_1,J_2,J_3)


% Getting rid of redundant gap closings

control_pi=compare_lambda(singularities_pi(:,1),step);
