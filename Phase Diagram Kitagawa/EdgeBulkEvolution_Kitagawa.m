...
omega_vec=[5]; %  Frequency (units of J)
periods=2*pi./omega_vec; % Period 
delta_vec=[2]; % Potential offset vector
lambda_vec=[1:step:5]; % Degree of anisotropy (lambda=1 identified with high frequency static regime)
