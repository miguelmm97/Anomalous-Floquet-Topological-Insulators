function qpi=top_charge_pi_lambda( cont_pi, singularities_pi, step, n_t, omega,J_1,J_2,J_3)
...
for j=1:length(control_pi(:,1))
    ...
    qpi(cont,:)=[ lambda, S_matrix_lambda(omega,kx,ky,delta,n_t,dt,h_0,J_1,J_2,J_3)];
    cont=cont+1;
end
end 