function [q0, kx0, ky0]=top_charge_0(cont_0, singularities_0, step, n_t, delta,J_1,J_2,J_3)
...
for j=1:length(control_0(:,1))
    ...
    omega=singularities_0(indice,1);
    kx=singularities_0(indice,2);
    ky=singularities_0(indice,3);   
    dt=singularities_0(indice,4);   
    h_0=0;
    q0(cont,:)=[ omega, S_matrix(omega,kx,ky,delta,n_t,dt,h_0,J_1,J_2,J_3)];
    kx0(cont,:)=kx;
    ky0(cont,:)=ky;
    cont=cont+1;
end
