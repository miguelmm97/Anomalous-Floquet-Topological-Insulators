function  [prod]=Time_evolution_bulk_4(delta,kx,ky,n_t,dt,J_1,J_2,J_3)
...
H4=@(delta,kx,ky)  [delta/2, 0; % Hamiltonian with only third hoping
                   0, -delta/2];
 ...
 U4=(expm(-1i*dt*H4(delta,kx,ky)))^n_t;
 prod=U1*U2*U3*U4;