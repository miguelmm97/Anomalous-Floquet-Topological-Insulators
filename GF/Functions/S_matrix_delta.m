function [q]=S_matrix_delta(omega,kx,ky,delta,n_t,dt,h_0,J_1,J_2,J_3)
...
HF= 1i*logm(Time_evolution_bulk(delta+change, kx, ky, n_t, dt,J_1,J_2,J_3)*expm(1i*eye(2).*h_0));
