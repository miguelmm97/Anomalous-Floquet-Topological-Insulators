function [HF, H1, H2, H3] = Floquet_kit_cyl(delta, lambda, J_1, J_2, J_3, Nx, Ny, position_matx, T, t0)
% This function constructs the Floquet hamiltonian of a finite strip provided the
% couplings, delta and lambda and the period and initial time in the Kitagawa drive.
