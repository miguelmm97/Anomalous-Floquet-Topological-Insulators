...
%% Parameters
omega=2.5; % Frequency of the drive ([J])
delta=0.01; % Potential offset ([J])
...
for i=1:length(kx);   
    ...
    [eigenstates, eigenvalues]=Time_evolution_edge(kx(i), N_layers, n_t, dt, J_1, J_2, J_3, delta, lambda);
