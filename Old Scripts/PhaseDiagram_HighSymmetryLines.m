...
J_1=2; % Hoping amplitudes (units of J)
...
n_t=1000; % Resolution of the time vector used in the time evoulution
...
for z=1:length(delta)
    ...
    if cont_0>1
        [q0, kx0, ky0]=top_charge_0(cont_0, singularities_0, step, n_t, delta(z),J_1,J_2,J_3);
    ...
    if cont_pi>1
        [qpi, kxpi, kypi]=top_charge_pi(cont_pi, singularities_pi, step, n_t, delta(z),J_1,J_2,J_3);
